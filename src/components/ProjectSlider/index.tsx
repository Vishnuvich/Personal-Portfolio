...
export default function ProjectSlider({ data }: IAppProps) {
    ...
    <>
      <div className="navigation-wrapper w-full">
        <div ref={sliderRef} className="keen-slider overflow-visible">
          {data.map((project) => (
            <div key={project.id} className='width-prop keen-slider__slide custom-shadow rounded-xl flex flex-col items-center text-slate-200  box-border overflow-hidden bg-lightNavy min-w-[18rem] max-w-[18rem] lg:max-w-[22rem]'>
              <div className=' overflow-hidden w-full '>
                <Image src={project.image} alt="instagramClone" width={400} height={400} className='w-full object-cover scale-100 hover:scale-110 duration-300 h-[280px] sm:h-[380px] md:h-[280px]' />
              </div>
